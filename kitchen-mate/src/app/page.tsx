...
export default function Home() {
  ...
  console.log(dataApi?.recipes, "ini data api");
  return (
    <>
      <div className="flex items-center">
        <section
          className="bg-cover bg-center py-32 w-full shadow-md"
          style={{
            backgroundImage:
          ...
          >
            <div className="flex items-center">
              <div className="w-1/2 ml-4">
                <h1 className="text-5xl font-medium mb-6 text-primary">
                  <b>KitchenMate</b>
                </h1>
                <p className="text-xl mb-12 text-black">
                  <b>
                    {" "}
                    "Kitchen Mate" describes an application as a buddy that
                    assists in managing and cooking in the kitchen. Make life
                    easier with #kitchenMate!
                  </b>
                </p>
                <Link href="/login">
                  <button className="bg-primary py-4 px-12 rounded-full hover:bg-secondary">
                    Login
                  </button>
                </Link>
              </div>
      ...
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-4 gap-4 mb-7">
          {dataApi?.recipes?.slice(0, 4).map((recipt, i) => {
            return (
              <div key={i}>
